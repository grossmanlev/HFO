...
def main ():
  ...
  if TRAIN:
    ...
    qvals = np.load('player1_heuristic_rl_actions4_states25_weights_6_2_3_1_2vs2.npy').tolist()
  ...
  for episode in itertools.count():
    ...
    if TRAIN:
      if episode_num % 5 == 0:
        q = np.array(qvals)
        np.save('player1_heuristic_rl_actions4_states25_weights_6_2_3_1_2vs2.npy', q)
