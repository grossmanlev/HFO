...
def main ():
  ...
  if TRAIN:
    ...
    qvals = np.load('smartagent_passive_heuristic_rl_actions4_states25_weights_1_1_10_10_4Dvs40.npy').tolist()
  ...
  for episode in itertools.count():
    ...
    if TRAIN:
      if episode_num % 5 == 0:
        q = np.array(qvals)
        np.save('smartagent_passive_heuristic_rl_actions4_states25_weights_1_1_10_10_4Dvs40.npy', q)
